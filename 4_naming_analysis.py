...
def initialize_project():
    ...
    project_dir = os.path.join("Skriptversionen/data", book_name)
    os.makedirs(project_dir, exist_ok=True)
    os.makedirs("Skriptversionen/data", exist_ok=True)  # Für globale Dateien, falls nicht vorhanden
    ...
    paths = {
        ...
        # Globale Dateien
        "lemma_normalization_json": os.path.join("Skriptversionen/data", "lemma_normalization.json"),
        "ignored_lemmas_json": os.path.join("Skriptversionen/data", "ignored_lemmas.json"),
        "lemma_categories_json": os.path.join("Skriptversionen/data", "lemma_categories.json")
    }
...
def load_or_extend_naming_variants_dict():
    ...
    """
    os.makedirs("Skriptversionen/data", exist_ok=True)
    dict_path = os.path.join("Skriptversionen/data", "naming_variants_dict.json")
...
def run_wordlist_menu(paths, book_name):
    ...
    output_dir = os.path.join("Skriptversionen/data", book_name, "analysis")
...
def generate_keywords(
    ...
    if reference_books:
        for book in reference_books:
            path = os.path.join("Skriptversionen/data", f"categorization_{book}.json")
...
def generate_collocations(
    ...
    """
    json_path = os.path.join("Skriptversionen/data", book_name, f"categorization_{book_name}.json")
    entries = safe_read_json(json_path, default=[])
...
def load_collocation_sheet(config_data: dict, book_name: str) -> pd.DataFrame | None:
    ...
    """
    primary_path = os.path.join("Skriptversionen/data", book_name, f"{book_name}_final.xlsx")
...
def run_visualization_menu(paths, book_name):
    ...
    output_dir = os.path.join("Skriptversionen/data", book_name, "visualization")
    os.makedirs(output_dir, exist_ok=True)
